...
# This code is based on HuggingFace's Qwen2 model.
...
from transformers.modeling_outputs import BaseModelOutputWithPast, CausalLMOutputWithPast, \
    SequenceClassifierOutputWithPast, MoeModelOutputWithPast, MoeCausalLMOutputWithPast
...
class Qwen2BlockSparseTop2MLP(nn.Module):
...
class QwenSparseMoeBlock(nn.Module):
    def __init__(self, config):
        ...
        self.experts = nn.ModuleList(
            [
                Qwen2BlockSparseTop2MLP(config) for _ in range(self.num_experts)
            ]
        )
